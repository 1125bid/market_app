...
import 'package:flutter_market_app/ui/pages/chat_detail/widgets/chat_detial_product_area.dart';
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
          ...
          bottomSheet:
              ChatDetailBottomSheet(MediaQuery.of(context).padding.bottom),
          body: Column(
            children: [
